...
namespace BluOsNadRemote.App.Resources.Languages {
    ...
    internal class AppResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The action could not be executed: {0}.
        /// </summary>
        internal static string PlayerActionFailed {
            get {
                return ResourceManager.GetString("PlayerActionFailed", resourceCulture);
            }
        }
